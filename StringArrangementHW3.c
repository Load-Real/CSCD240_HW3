...
void swapElements(char **s, char** t);
int main(){
       ...
       // EOF reached. Now count the number of strings read
        printf("\nCount is %d\n\n", count);
	// printString(s, count); <-- This ended up not looking like the output screenshot given
